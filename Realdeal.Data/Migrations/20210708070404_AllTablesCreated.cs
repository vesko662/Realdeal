...
namespace Realdeal.Data.Migrations
{
    public partial class AllTablesCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ObservedAdverts",
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AdvertId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StartedObserving = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SendEmailOnUpdate = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObservedAdverts", x => new { x.AdvertId, x.UserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ObservedAdverts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObservedAdverts_UserId",
